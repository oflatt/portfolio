...
publishing it to Steam, although it will not happen within a single year.")
...
and programming in general, I attended the past three Racket Con events. I listened to many interesting talks,
...
(write-html
 (page
  `(div
    ...
    ,(build-post "Racket Con" "Racket" "2015, 2016, and 2017"
