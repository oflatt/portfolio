...
This post took me a couple tries to get right! @link["incorrect-egraph-union.html"]{My original post} claimed that I had a correct implementation of egraph intersection (which I now know is impossible).
